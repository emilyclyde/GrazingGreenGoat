...
{
  public class FinalInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<FinalContext>
  {
    protected override void Seed(FinalContext context)
    {
      ...
      var lots = new List<Lot>
            ...
            new Lot{ID= 4, GoatID=4, CustomerID=4, CustomerFirst="Leo", CustomerLast="Lion",GoatName="Gytis", LotAddress="100 South Ave", LotDescription= "Forest"}
            };
